...
<div class="calc-section">
  ...
  <table class="input-table">
    ...
    <tr>
      <th>年齢</th>
      <td><input type="number" id="age" value="30" min="10" max="100" style="width:100px;"> 歳</td>
    </tr>
    <tr>
      <th>身長</th>
      <td><input type="number" id="height" value="170" min="100" max="250" step="0.1" style="width:110px;"> cm</td>
    </tr>
    <tr>
      <th>体重</th>
      <td><input type="number" id="weight" value="65" min="30" max="300" step="0.1" style="width:110px;"> kg</td>
    </tr>
    <tr>
      <th>活動レベル</th>
      <td>
